...
def run_test_make_simple_string():
    ...
    print('--------------------------------------------------')
    expected = '11 - 12 - 13 - 14 - 15 - 16 -'
    actual = make_simple_string(11, 16)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    print('--------------------------------------------------')
    expected = '11 - 12 - 13 - 14 - 15 - 16'
    actual = make_less_simple_string(11, 16)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        circle=circles[k]
        point1=rg.Point.clone(circle.center)
        point2=rg.Point.clone(circle.center)
        y=circle.radius
        point1.move_by(-y,-y)
        point2.move_by(y,y)
